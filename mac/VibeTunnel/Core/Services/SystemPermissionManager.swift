...
enum SystemPermission {
    ...
    var explanation: String {
        switch self {
        case .appleScript:
            return "Required to launch and control terminal applications"
        case .screenRecording:
            return "Required to track and focus terminal windows"
        case .accessibility:
            return "Required to send keystrokes to terminal windows"
        }
    }
...
final class SystemPermissionManager {
    ...
    var hasAllPermissions: Bool {
        permissions.values.allSatisfy { $0 }
    }
