...
export function getAvailableTerminals(): Terminal[] {
...
function getMacTerminals(): Terminal[] {
...
function getWindowsTerminals(): Terminal[] {
  const terminals: Terminal[] = [];
...
function getLinuxTerminals(): Terminal[] {
  const terminals: Terminal[] = [];
...
export async function openTerminal(terminalCommand: string, options: OpenTerminalOptions = {}): Promise<void> {
  const platform = process.platform;
